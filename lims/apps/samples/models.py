...
class Sample(models.Model):
    ...
    last_menstrual_period = models.DateField(null=True, blank=True, help_text="Last menstrual period")
    physician = models.CharField(max_length=100, blank=True, default="", help_text="Referring physician")
    pregnancy_history = models.CharField(max_length=500, blank=True, default="", help_text="Pregnancy history (gravida/para)")
    fedex_no = models.CharField(max_length=50, blank=True, default="", help_text="FedEx tracking number")
    price = models.CharField(max_length=50, blank=True, default="", help_text="Price (Brazil-specific)")
    sinal = models.CharField(max_length=50, blank=True, default="", help_text="Sinal/deposit (Brazil-specific)")
    balance = models.CharField(max_length=50, blank=True, default="", help_text="Balance (Brazil-specific)")
    gender_info = models.CharField(max_length=50, blank=True, default="", help_text="Gender info / fetal gender (Brazil-specific)")
    report_due_date = models.CharField(max_length=50, blank=True, default="", help_text="Report due date (Brazil-specific)")
    acceptance_date = models.DateField(null=True, blank=True, help_text="Sample acceptance date")
    test_option = models.CharField(max_length=20, blank=True, default="", help_text="Test option (basic/basic_all/plus)")
    zscore_21 = models.FloatField(null=True, blank=True, help_text="Z-score for chromosome 21")
    zscore_18 = models.FloatField(null=True, blank=True, help_text="Z-score for chromosome 18")
    zscore_13 = models.FloatField(null=True, blank=True, help_text="Z-score for chromosome 13")
    t21 = models.CharField(max_length=20, blank=True, default="", help_text="T21 result")
    t18 = models.CharField(max_length=20, blank=True, default="", help_text="T18 result")
    t13 = models.CharField(max_length=20, blank=True, default="", help_text="T13 result")
    xo = models.CharField(max_length=20, blank=True, default="", help_text="XO result")
    xxx = models.CharField(max_length=20, blank=True, default="", help_text="XXX result", db_column="xxx_col")
    xxy = models.CharField(max_length=20, blank=True, default="", help_text="XXY result")
    xyy = models.CharField(max_length=20, blank=True, default="", help_text="XYY result")
    all_chrom = models.CharField(max_length=20, blank=True, default="", help_text="All chromosome result")
    gender = models.CharField(max_length=10, blank=True, default="", help_text="Fetal gender prediction")
    other = models.CharField(max_length=500, blank=True, default="", help_text="Other notes", db_column="other_col")
    ...
    status = models.CharField(
        ...
        choices=[
            ...
            ("SEQUENCING", "NIPT — 上机测序"),
            ("BIOINFORMATICS", "NIPT — 生物信息分析"),
            ("TESTING", "Testing"),
            ("ANALYZING", "Analyzing"),
            ("COMPLETED", "Completed"),
            ("REPORTED", "Reported"),
