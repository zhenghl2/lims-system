...
class Sample(models.Model):
    ...
    xxx = models.CharField(max_length=20, blank=True, default="", help_text="XXX result")
    ...
    other = models.CharField(max_length=500, blank=True, default="", help_text="Other notes")
